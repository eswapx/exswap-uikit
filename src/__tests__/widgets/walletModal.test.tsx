    ...
    <DocumentFragment>
      ...
      >
        ...
        >
          ...
          >
            <h2
              class="sc-bdfBwQ sc-hKgILt qUofH bCnOmg"
              color="text"
            >
              Connect to a wallet
            </h2>
          ...
          <button
            ...
            class="sc-jSgupP fcvUso sc-gKsewC kpTpvg"
            type="button"
          >
            <svg
              class="sc-dlfnbm jZpDUo"
              color="primary"
              viewBox="0 0 24 24"
              width="20px"
        ...
        >
          <button
            class="sc-jSgupP cchgFZ"
            id="wallet-connect-metamask"
            style="justify-content: space-between;"
            type="button"
          >
            <div
              class="sc-bdfBwQ epMgZo"
              color="primary"
            >
              Metamask
            </div>
          ...
          <a
            ...
            color="primary"
            href="https://docs.exchangeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain"
            rel="noreferrer noopener"
            target="_blank"
          >
            <svg
              class="sc-dlfnbm jrAEwI"
              color="primary"
              viewBox="0 0 20 20"
              width="20px"
              xmlns="http://www.w3.org/2000/svg"
    ...
    <DocumentFragment>
      ...
      >
        ...
        >
          ...
          >
            <a
              class="sc-bdfBwQ sc-gsTCUz isVlCO djpNeP"
              color="primary"
            ...
            <div
              class="sc-bdfBwQ sc-crrsfI JzvZ jjcftS"
              color="text"
              role="button"
            >
              Copy Address
